...
/**
 * @brief IntToChar Convierte un entero en una cadena de caracres
 *
 ...
 *
 * @param num Numero (int) a convertir
 * @param string Referencia (char *) a en la que se almacena la conversion
 */
...
/**
 * @brief PrintlnStringsTypeChars Imprime una cadena de caracres agregando salto de linea
 *
